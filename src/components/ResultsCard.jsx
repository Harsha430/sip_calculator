export default function ResultsCard({ title, amount, highlight }) {
  ...
  return (
    ...
    } shadow-sm flex flex-col items-start gap-2 transition-all duration-300 hover:shadow-md`}>
      <h3 className="text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300">
        {title}
      </h3>
